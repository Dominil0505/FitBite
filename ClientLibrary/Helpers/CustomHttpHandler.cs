...
namespace ClientLibrary.Helpers
{
    public class CustomHttpHandler(
        GetHttpClient getHttpClient,                // A HTTP kliens beszerzésére szolgáló függőség
        LocalStorageService localStorageService,     // Helyi tároláshoz kapcsolódó szolgáltatás a token tárolására
        IUserAccountService accountService)          // A felhasználói fiók kezelést biztosító szolgáltatás
        : DelegatingHandler                           // Az osztály örökli a DelegatingHandler-t, hogy közvetítőként működhessen a kérés és válasz között
    {
